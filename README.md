...
This tool is based upon [Psi](https://github.com/BS2010-AirborneTroops/Tracking-location-Camera-link) .This is a telegram implementation with extra features than Psi.
...
1. Copy it's API key
1. Clone the repo using `git clone https://github.com/BS2010-AirborneTroops/Tracking-location-Camera-link  `
1. `cd TrackDown`
